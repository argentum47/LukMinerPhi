...
# enable huge-page support for the O/S. This requires sudo priviledge.
...
# I am not the original author. Credit goes out to whomever originally wrote this. 
# I modified the comments to be more useful to someone relatively new to mining.
